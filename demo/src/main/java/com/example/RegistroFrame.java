...
public class RegistroFrame extends JFrame {
    ...
    private void initUI() {
        ...
        panel.setLayout(new GridLayout(4, 2, 10, 10));  // Diseño de la cuadrícula con espacios entre elementos.
        ...
        panel.add(new JLabel("DNI:"));  // Etiqueta para el DNI.
        ...
        panel.add(new JLabel());  // Añade un JLabel vacío para alinear el botón en la cuadrícula.
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            DBmanager gestorDB = new DBmanager();  // Suponiendo que puedes instanciar así.
